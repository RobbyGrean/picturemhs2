...
### 🚀 คู่มือนำระบบไปต่อยอด

- [ย้ายไปใช้กับหน่วยงาน อีเมล และ Google Drive ชุดใหม่](ORGANIZATION_MIGRATION_GUIDE.md)
- [ติดตั้งสำหรับบุคคลเดียวแบบ Admin Hub](PERSONAL_SINGLE_USER_GUIDE.md)
...
| ไฟล์ขึ้น Drive แต่ Apps Script ตอบกลับไม่สมบูรณ์ | ระบบจะตรวจ metadata ซ้ำอัตโนมัติประมาณ 10 วินาที; หากยังยืนยันไม่ได้ ให้รอแล้วค้นหากิจกรรมก่อน ห้ามอัปโหลดไฟล์ชุดเดิมซ้ำ |
